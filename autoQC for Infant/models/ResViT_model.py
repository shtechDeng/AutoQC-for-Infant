...
from structures.modules import Flatten, AddingNodes, Flatten1
...
class ResNet(nn.Module):
    def __init__(self, input_size, **kwargs):
        ...
        d, h, w = ResVit._maxpool_output_size(input_size[1::], nb_layers=5)
        self.ft = Flatten()
        self.linner = nn.Linear(d * h * w, 256)
    ...
    def _maxpool_output_size(input_size, kernel_size=(3, 3, 3), stride=(2, 2, 2), nb_layers=1):
        ...
        if nb_layers == 1:
            return d, h, w
        return ResVit._maxpool_output_size((d, h, w), kernel_size=kernel_size, stride=stride, nb_layers=nb_layers-1)
...
class PatchEmbed(nn.Module):
    ...
    def _maxpool_output_size(input_size, kernel_size=(3, 3, 3), stride=(2, 2, 2), nb_layers=1):
        ...
        if nb_layers == 1:
            return d, h, w
        return ResNet._maxpool_output_size((d, h, w), kernel_size=kernel_size, stride=stride,
    ...
    def __init__(self, img_size1=208, img_size2=304, img_size3=320, patch_size=16, in_c=1, embed_dim=768, norm_layer=None):
        ...
        self.layer1 = self._make_block(1, in_c)
        self.layer2 = self._make_block(2)
        self.layer3 = self._make_block(3)
        self.layer4 = self._make_block(4)
        self.layer5 = self._make_block(5)
...
class ResVit(nn.Module):
    def __init__(self, img_size1=208, img_size2=304, img_size3=320, patch_size=16, in_c=1, num_classes=2,
                 embed_dim=128, depth=12, num_heads=8, mlp_ratio=4.0, qkv_bias=True,
